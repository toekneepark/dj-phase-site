  ...
  render: function () {
    ...
    return h('div', { className: 'preview-container' },
      ...
      h('div', { className: 'content' },
        // Current post being edited (highlighted)
        h('div', { className: 'card', style: { borderColor: 'rgba(124,58,237,0.4)' } },
          ...
          h('span', { style: { display: 'inline-block', marginTop: '16px', fontSize: '14px', fontWeight: 500, color: '#a78bfa' } }, 'Read more →'),
        ),
        // Placeholder older posts
        h('div', { className: 'card', style: { opacity: 0.5 } },
          h('div', { className: 'meta' },
            h('time', {}, 'February 15, 2026'),
            h('span', {}, '·'),
            h('span', {}, '3 min read'),
            h('span', { className: 'category' }, 'Behind the Scenes'),
          ),
          h('h2', {}, 'A Day in the Life: Radio to the Club'),
          h('p', { style: { marginTop: '12px', color: 'rgba(226,232,240,0.5)', fontSize: '15px', lineHeight: 1.7 } },
            'People always ask what it\'s like to do radio during the week and DJ on weekends...'),
          h('span', { style: { display: 'inline-block', marginTop: '16px', fontSize: '14px', fontWeight: 500, color: '#a78bfa' } }, 'Read more →'),
        ),
        h('div', { className: 'card', style: { opacity: 0.5 } },
          h('div', { className: 'meta' },
            h('time', {}, 'January 28, 2026'),
            h('span', {}, '·'),
            h('span', {}, '4 min read'),
            h('span', { className: 'category' }, 'Gear'),
          ),
          h('h2', {}, 'My 2026 Setup: Gear That Makes the Magic Happen'),
          h('p', { style: { marginTop: '12px', color: 'rgba(226,232,240,0.5)', fontSize: '15px', lineHeight: 1.7 } },
            'Every DJ gets asked about their setup. Here\'s what I\'m rocking this year...'),
          h('span', { style: { display: 'inline-block', marginTop: '16px', fontSize: '14px', fontWeight: 500, color: '#a78bfa' } }, 'Read more →'),
        ),
      ),
    );
...
const GigPreview = createClass({
  render: function () {
    ...
    return h('div', { className: 'preview-container' },
      ...
      h('div', { className: 'content' },
        // Current gig being edited (highlighted)
        h('div', { className: 'card', style: { display: 'flex', gap: '20px', alignItems: 'center', borderColor: 'rgba(124,58,237,0.4)' } },
        ...
        // Placeholder gigs
        h('div', { className: 'card', style: { display: 'flex', gap: '20px', alignItems: 'center', opacity: 0.5 } },
          h('div', { style: { flexShrink: 0, width: '70px', textAlign: 'center' } },
            h('p', { style: { fontSize: '20px', fontWeight: 900, color: '#a78bfa' } }, 'FRI'),
            h('p', { style: { fontSize: '11px', color: 'rgba(226,232,240,0.4)' } }, 'Every Week'),
          ),
          h('div', { style: { flexGrow: 1 } },
            h('h2', { style: { marginTop: 0, fontSize: '18px' } }, 'FUEGO Fridays'),
            h('p', { style: { fontSize: '13px', color: 'rgba(226,232,240,0.5)', marginTop: '4px' } }, '📍 Fuego Bar & Lounge · Seattle, WA'),
          ),
        ...
        h('div', { className: 'card', style: { display: 'flex', gap: '20px', alignItems: 'center', opacity: 0.5 } },
          ...
          h('div', { style: { flexGrow: 1 } },
            h('h2', { style: { marginTop: 0, fontSize: '18px' } }, 'Legion Sports Bar'),
            h('p', { style: { fontSize: '13px', color: 'rgba(226,232,240,0.5)', marginTop: '4px' } }, '📍 700 Bellevue Way NE · Bellevue, WA'),
          ),
